...
async function runAdvRepeat(){
  ...
  for(var i=0;i<count;i++){
    ...
    try{
      ...
      var fH={};if(h.headers)h.headers.filter(function(x){return x.on!==false&&x.k;}).forEach(function(x){fH[x.k]=x.v;});
